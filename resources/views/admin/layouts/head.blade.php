<head>
   ...
   <link rel="stylesheet" type="text/css" href="{{ asset('asset/admin/src/plugins/css/dark/table/datatable/custom_dt_miscellaneous.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('asset/admin/src/plugins/src/sweetalerts2/sweetalerts2.css') }}">

    <link href="{{ asset('asset/admin/src/assets/css/light/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('asset/admin/src/plugins/css/light/sweetalerts2/custom-sweetalert.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('asset/admin/src/assets/css/dark/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('asset/admin/src/plugins/css/dark/sweetalerts2/custom-sweetalert.css') }}" rel="stylesheet" type="text/css" />
